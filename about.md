...
<div style="text-align: center; margin-bottom: 2rem;">
  ...
  <div style="display: flex; justify-content: center; gap: 10px;">
    <a href="https://github.com/hujianbest" target="_blank" style="color: #333; text-decoration: none;">
...
- **样式方案**: Sass/Less, Tailwind CSS, Ant Design

### 后端技术
- **语言**: Node.js, Python, Java
- **框架**: Express, Django, Spring Boot
- **数据库**: MySQL, MongoDB, Redis
- **部署**: Docker, CI/CD, Linux
...
- **博客**: [hujianbest.github.io](https://hujianbest.github.io)
- **邮箱**: 你的邮箱地址（如果需要公开）
...
感谢您来到我的个人博客！如果我的内容对您有所帮助，欢迎关注和支持。

> "保持好奇，持续学习，让技术改变生活。" — hujianbest